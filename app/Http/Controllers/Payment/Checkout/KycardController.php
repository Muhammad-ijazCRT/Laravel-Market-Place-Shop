...
class KycardController extends CheckoutBaseControlller
{
    ...
    public function mlmLogin(Request $request)
    {
        $input = $request->all();
...
$cardData = Session::get('cart');
        ...
        //     return response()->json(['response' => $responseData], $response->status());
        // } catch (\Exception $e) {
        //     return response()->json(['error' => 'Error sending request: ' . $e->getMessage()], 500);
        // }
