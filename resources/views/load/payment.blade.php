...
@if($payment == 'other')
  ...
  <div class="row" >
    ...
    <div class="col-lg-6">
      ...
      <input class="form-control" name="mlm_email" type="email" placeholder="{{ __('MLM Email') }}"  required />
      <input class="form-control" name="mlm_password" type="text" placeholder="{{ __('Password') }}"  required />
